...
<body>
    <div class="bg-cover bg-center" style="background-image: url(https://png.pngtree.com/thumb_back/fw800/background/20230610/pngtree-four-black-and-orange-bugatti-cars-are-parked-in-the-streets-image_2971199.jpg)">
        <nav class="container mx-auto flex items-center justify-between py-4">
          <div class="text-green-400 text-3xl font-bold">CARBOOK</div>
        ...
        <div class="container mx-auto flex flex-col items-center justify-center px-4 py-20 text-center text-white">
          <h1 class="text-6xl font-bold">Fast &amp; Easy Way To Rent A Car</h1>
          <p class="mt-4 text-lg">
            A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a
            paradisematic country, in which roasted parts of sentences fly into your mouth.
          </p>
          <button class="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 px-4 py-2 mt-8 bg-green-500 hover:bg-green-600 text-white">
      ...
      <div class="bg-white p-8">
        <h2 class="text-4xl font-bold text-center mb-6">Featured Vehicles</h2>
          ...
          <div class="space-y-4">
            ...
            <div class="space-y-2">
              ...
              <div class="flex space-x-2">
                <button class="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-primary/90 h-10 px-4 py-2 bg-blue-500 text-white">
                  Book now
                </button>
                <button class="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-primary/90 h-10 px-4 py-2 bg-gray-200 text-gray-700">
                  Details
                </button>
              </div>
            </div>
